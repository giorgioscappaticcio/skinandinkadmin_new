...
/**
 * @ngdoc directive
 * @name adminApp.directive:fullpage/fbInt/fbintegration
 * @description
 * # fullpage/fbInt/fbintegration
 */
angular.module('adminApp')
  .directive('fbintegration', function (CommonMain, $timeout) {
    return {
      templateUrl: '/views/fullpage/fbint/fbintegration.html',
      restrict: 'AE',
